package com.example.pc.databasesync;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    * */
    public static final String URL_SAVE_NAME = "http://192.168.0.13/SqliteSync/saveName.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   listViewNames.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
              //  Object o = nameAdapter.getItem(position);
                names.remove(nameAdapter.getItem(position));
        ...
        switch(item.getItemId())
        {
            case R.id.delete_id:
               // names.remove(info.position);
                db.deleteNameINLocalStorage("cat");
                refreshList();
            default:
